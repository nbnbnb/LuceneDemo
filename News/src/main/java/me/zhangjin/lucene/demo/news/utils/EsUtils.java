package me.zhangjin.lucene.demo.news.utils;

import me.zhangjin.lucene.demo.news.dao.Dao;
...
public class EsUtils {
    ...
    public static final String CLUSTER_NAME = "kkking";
    public static final String HOST_IP = "111.231.82.204";
    public static final int TCP_PORT = 19300;
    ...
    public static void main(String[] args) {
        ...
        EsUtils.createIndex("spnews", 3, 1);
