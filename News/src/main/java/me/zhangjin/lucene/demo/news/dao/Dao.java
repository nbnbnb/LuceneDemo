package me.zhangjin.lucene.demo.news.dao;

import me.zhangjin.lucene.demo.news.utils.EsUtils;
...
public class Dao {
    ...
    public void getConnection() {
        ...
        try {
            ...
            String user = "boot";
            String passwd = "boot";
            String url = "jdbc:mysql://zhangjin.ml:23306/boot?characterEncoding=utf8&useSSL=false";
    ...
    public void mysqlToEs() {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                var kkk = client.prepareIndex("spnews", "news", String.valueOf(nid))
                        .setSource(map)
                        .execute()
                        .actionGet();
